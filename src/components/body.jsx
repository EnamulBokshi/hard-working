...
export default function Body() {
    ...
    const pra = "py-8 text-gray-500 px-8 md:text-3xl font-mono  mb-5 hover:text-gray-700 delay-200 duration-200 text-justify"
  const card =
    ...
    <>
      <section className="w-100 bg-neutral-300 py-6">
        <div className=" py-5 px-16 container mx-auto">
          ...
          <div className="grid md:grid-cols-2 p-1 rounded-md md:gap-12 bg-[url('./assets/images/thumb1.jpg')] bg-cover bg-fixed ">
